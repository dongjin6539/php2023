...
<body class="gray">
    ...
    <div class="blog__title" style="background-image: url('../assets/blog/<?= $blogInfo['blogImgFile'] ?>');">
            ...
            <p class="title"><?= $blogInfo['blogTitle'] ?></p>
            <div class="info">
        ...
        <div class="blog__comment">
            ...
            <div class="comment__view">
                ...
                <div class="info">
                    ...
                    <p class="msg">감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. 감사합니다. </p>
                    
                    <div class="comment__delete">
                        <label for="commentPassword" class="blind">비밀번호</label>
                        <input type="password" id="commentPassword" name="commentPassword" placeholder="비밀번호를 입력하세요!">
                    ...
                    <div class="comment__modify">
                        ...
                        <textarea name="msg__modify" id="msg__modify" rows="4" placeholder="수정할 내용을 입력하세요!"></textarea>
                        <label for="commentPassword" class="blind">비밀번호</label>
                        <input type="password" id="commentPassword" name="commentPassword" placeholder="비밀번호를 입력하세요!">
            ...
            <div class="comment__write mt30">
                ...
                <textarea id="commentWrite" name="commentWrite" rows="4" placeholder="댓글을 작성해주세요!"></textarea>
                <button type="submit" class="btnStyle3 mt10">댓글쓰기</button>
            </div>
        </div>
        <!-- //blog__comment -->
    </main>
